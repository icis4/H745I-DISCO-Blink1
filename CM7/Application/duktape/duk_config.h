...
#define DUK_USE_EXEC_TIMEOUT_CHECK duktype_timeout_check
#define DUK_USE_FATAL_HANDLER duktype_fatal
#define DUK_USE_GET_MONOTONIC_TIME HAL_GetTick
...
extern void duktype_fatal(void *udata, const char *msg);
extern duk_bool_t duktype_timeout_check(void *udata);
